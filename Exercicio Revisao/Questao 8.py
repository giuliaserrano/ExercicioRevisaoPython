...
print(" A soma dos valores dos elementos do vetor eh: %d\n" %(somaVetor))
print(" A media dos valores do elementos do vetor eh: %d\n"%(somaVetor/len(lista_notas)))
...
print(" A quantidade de valores acima da media eh: %d\n"%(acima_Media))
...
print(" A quantidade de valores abaixo de sete eh: %d\n"%(abaixoSete))
